...
TEST_CASES = [
...

    {
        ...
        "request": {
            "message":
                "使用Peng-Robinson计算甲烷、乙烷和氮气的TP Flash，"
                "温度110 K，压力100 kPa，"
...

    {
        ...
        "request": {
            "message":
                "判断甲烷乙烷混合物在300 K、5000 kPa条件下的相态"
        },
    },
...

    {
        ...
        "request": {
            "message":
                "Wilson、NRTL、UNIQUAC和Peng-Robinson模型有什么区别？"
        },
    },
...

    {
        ...
        "request": {
            "message":
                "计算甲烷乙烷混合物在-163摄氏度、100 kPa下TP Flash"
        },
    },
