...
from schemas.domain import CalculationResult, ModelRecommendation, TaskManifest, ValidationReport
...
def test_frontend_contract_declares_all_backend_fields() -> None:
    ...
    for model in (TaskManifest, CalculationResult, ValidationReport, ModelRecommendation):
